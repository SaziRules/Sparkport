          ...
          <div className="px-8 lg:px-12 py-8 space-y-8">
            ...
            <section className="grid grid-cols-1 sm:grid-cols-2 gap-4 items-start">
              ...
              <div className="rounded-2xl overflow-hidden border border-neutral-200 shadow-sm">
                <div className="bg-[#184363] px-5 py-4 flex items-center justify-between">
                  <div className="flex items-center gap-2.5">
                    ...
                    <h2 className="text-white font-semibold text-sm tracking-wide">Trading Hours</h2>
                  </div>
                  <OpenIndicator hours={store.hours} />
                </div>
                <div className="divide-y divide-neutral-100 bg-white">
                  {hourRows.map((row, i) => (
                    <div key={i} className="flex items-center justify-between px-5 py-3">
                      <span className="text-neutral-400 text-xs font-semibold uppercase tracking-widest">{row.label}</span>
                      <span className={`text-sm font-semibold ${row.time ? 'text-neutral-800' : 'text-neutral-400'}`}>
                        {row.time || 'Closed'}
                      </span>
                    </div>
                  ))}
              ...
              {/* Contact */}
              <div className="rounded-2xl overflow-hidden border border-neutral-200 shadow-sm">
                <div className="bg-[#009eb9] px-5 py-4 flex items-center gap-2.5">
                  <div className="w-8 h-8 bg-white/15 rounded-lg flex items-center justify-center shrink-0">
                    <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <h2 className="text-white font-semibold text-sm tracking-wide">Contact Us</h2>
                </div>
                <div className="divide-y divide-neutral-100 bg-white">

                  <div className="px-5 py-3.5">
                    <p className="text-neutral-400 text-xs font-semibold uppercase tracking-widest mb-1">Address</p>
                    <p className="text-neutral-800 text-sm leading-snug">{store.address}</p>
                  </div>
                  ...
                  >
                    <div className="w-8 h-8 bg-[#009eb9]/10 rounded-lg flex items-center justify-center shrink-0 group-hover:bg-[#009eb9]/20 transition-colors">
                      <svg className="w-4 h-4 text-[#009eb9]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                      </svg>
                    </div>
                    <div>
                      <p className="text-neutral-400 text-xs font-semibold uppercase tracking-widest">Phone</p>
                      <p className="text-neutral-800 text-sm font-medium">{store.phone}</p>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      <p className="text-neutral-400 text-xs font-semibold uppercase tracking-widest">Email</p>
                      <p className="text-neutral-800 text-sm font-medium truncate">{store.email}</p>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-neutral-400 text-xs font-semibold uppercase tracking-widest">WhatsApp</p>
                      <p className="text-neutral-800 text-sm font-medium">Message us</p>
                    </div>
                  </a>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-neutral-400 text-xs font-semibold uppercase tracking-widest">Directions</p>
                      <p className="text-neutral-800 text-sm font-medium">Open in Maps</p>
                    </div>
                  </a>
