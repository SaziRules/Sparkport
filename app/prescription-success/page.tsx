...
function SuccessContent() {
  ...
  // Start signup timer only once we confirm user is anonymous
  useEffect(() => {
    if (isLoggedIn === false) {
    ...
    <div className="relative min-h-screen">
      ...
      <main className="relative px-1 py-8 lg:py-32 min-h-screen">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Logged-in user: quick-access card */}
          {isLoggedIn === true && (
            <div className="mb-8 bg-linear-to-r from-[#184363] to-[#1a5a8a] rounded-3xl shadow-2xl overflow-hidden animate-[slideUp_0.5s_ease-out]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                  <div className="lg:col-span-7">
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div>
                        <h3 className="text-2xl lg:text-3xl font-extrabold text-white mb-2">Your prescription is saved to your account</h3>
                        <p className="text-white/80 text-base">Track it anytime from your dashboard.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="lg:col-span-5 flex flex-col gap-4">
                    <Link
                      ...
                      className="block px-8 py-4 bg-white text-[#184363] font-bold text-lg rounded-2xl hover:bg-neutral-100 transition-all shadow-xl text-center"
                    >
                      View My Prescriptions
                    </Link>
                    <Link
                      href="/account/dashboard"
                      className="block px-8 py-4 text-white border-2 border-white/30 font-semibold text-lg rounded-2xl hover:bg-white/10 transition-all text-center"
                    >
                      Go to Dashboard
                    </Link>
                  </div>
          ...
          {/* Anonymous user: delayed signup prompt */}
          {isLoggedIn === false && showSignupPrompt && (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
                  <div className="lg:col-span-7">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                      {['Real-time tracking', 'View all prescriptions', 'Saved addresses', 'Instant notifications'].map((feature) => (
                  ...
                  <div className="lg:col-span-5 flex flex-col gap-4">
                    <Link
                      href={`/account?email=${encodeURIComponent(email || '')}&phone=${encodeURIComponent(phone || '')}&returnTo=/account/dashboard`}
