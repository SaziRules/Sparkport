                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                  {filteredProducts.map((product) => (
                    ...
                    >
                      ...
                      {/* Product Image */}
                      <a href={`/product/${product.id}?from=promotions`} className="block">
                  ...
                  {filteredProducts.map((product) => (
                    ...
                    >
                      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 p-6 relative">
                        ...
                        {/* Product Image */}
                        <a href={`/product/${product.id}?from=promotions`} className="w-full sm:w-40 shrink-0 pt-8 sm:pt-0 block">
                          <img
                            src={product.image}
                            alt={product.name}
