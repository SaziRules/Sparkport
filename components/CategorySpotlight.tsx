...
// NOTE: Only include categories that have real product data.
// When WooCommerce API is connected, replace this static array with
// an API fetch and pass categories + products as props.
...
export default function CategorySpotlight() {
  ...
  const displayProducts = currentSpotlight.products;
      ...
      <div className="max-w-full mx-auto">
        ...
        {displayProducts.length === 0 && (
          <div className="text-center py-16 text-neutral-400">
            ...
            <p className="text-sm mt-1">Check back for updates in this category</p>
          </div>
        )}
