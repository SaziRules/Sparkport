...
export default function SignIn() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!email.trim()) {
      newErrors.email = 'Email or cellphone number is required';
    }

    if (!isOTP && !password.trim()) {
    ...
    <div className="min-h-screen bg-neutral-50 flex items-center justify-center py-12 px-4">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <h1 className="text-2xl font-extrabold! text-[#184363] text-center mb-2">
        ...
        <div className="mt-6 text-center">
          <p className="text-neutral-600">
            New to Sparkport?{' '}
            <Link href="/sign-up" className="font-semibold text-[#009eb9] hover:text-[#184363] transition-colors">
              Create an account
            </Link>
          </p>
        </div>
