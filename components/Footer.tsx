              ...
              <form onSubmit={handleSubscribe} className="mb-4">
                <div className="flex flex-col gap-2">
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-white text-neutral-900 placeholder:text-neutral-500 focus:outline-none rounded-lg"
                    required
                  />
                  <button
                    type="submit"
                    disabled={!acceptedTerms || subLoading}
                    className="w-full px-6 py-2.5 bg-[#00bcd4] text-white font-medium rounded-lg hover:bg-[#00acc1] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
